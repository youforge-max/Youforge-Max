...
class EditorExporter(private val context: Context) {
    ...
    private fun startOnMain(project: EditorProject, callback: Callback) {
        ...
        // Optional burned-in title (Youforge-Max text on video) via a Media3 text overlay.
        ...
        val outDir = File(context.getExternalFilesDir("Movies"), "Youforge-Max").apply { mkdirs() }

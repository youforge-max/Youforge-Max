...
- **Remaining backlog:** per-sticker drag is sliders+drag (done); device-verify crossfade, and if leading-gap is rejected, bump to Media3 1.8+ (compileSdk 36 + AGP upgrade) for `experimentalSetForceVideoTrack`.
